  ...
  return <>
    ...
    <section className="editorial-section section-white" id="domestic-services">
      <div className="shell editorial-grid">
        <div className="editorial-image" data-image-feedback="photo" data-photo-frame=""><Photograph name="selected-domestic" sizes="(max-width: 800px) 100vw, 58vw" alt="Illustrative delivery truck travelling on an intercity road"/><span>Illustrative route imagery</span></div>
    ...
    <section className="editorial-section international-feature">
      <div className="shell editorial-grid editorial-grid-reverse">
        ...
        <div className="editorial-image international-aircraft" data-image-feedback="photo" data-photo-frame=""><Photograph name="existing-aircraft" sizes="(max-width: 900px) 100vw, 41vw" alt="Antonov An-124 cargo aircraft above Lviv airport, with nose, tail and both wingtips in frame"/><span>Illustrative international logistics</span></div>
