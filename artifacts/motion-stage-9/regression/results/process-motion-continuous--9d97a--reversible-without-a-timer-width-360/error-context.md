...
- Name: process-motion.spec.ts >> continuous scroll drives exact depth, opacity, number glow and line, reversible without a timer
- Location: artifacts/motion-stage-9/regression/process-motion.spec.ts:47:1
