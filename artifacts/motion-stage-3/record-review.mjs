...
for(const width of [1440,390]){
 const context=await browser.newContext({viewport:{width,height:900},deviceScaleFactor:width===390?3:2,hasTouch:width===390,isMobile:width===390,recordVideo:{dir:'artifacts/motion-stage-3/recordings',size:{width,height:900}}});
 ...
 await page.waitForTimeout(1300);const video=page.video();await context.close();await video.saveAs(`artifacts/motion-stage-3/hero-review-${width}.webm`);
}
